...
class StreamCalculatorTest {
    ...
    @BeforeEach
    void setup() {
        factory = new StackCalculatorFactory();
    }
    ...
    void fileAndStringTest() throws IOException {
        ...
        try (var fr = new FileReader("src/ss/week5/calculator/test/calculatorinstructions")) {
            // string writer! Basically writes to a string

...
public interface Calculator {
    ...
    /**
     * Divide the last two values of the stack and push their remainder.
     *
     * @throws StackEmptyException   if the stack does not have at least two values
     * @throws DivideByZeroException if value a had value 0
     */
    ...
    /**
     * Duplicate the value on top of the stack and push it.
     *
     * @throws StackEmptyException if the stack does not have at least two values
     */
    void dub() throws StackEmptyException;
}

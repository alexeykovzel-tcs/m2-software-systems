package ss.week4.calculator.test;

import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import ss.week4.calculator.Calculator;
import ss.week4.calculator.StackCalculator;
...
class CalculatorTest {
    ...
    void testDub() throws StackEmptyException {
        assertThrows(StackEmptyException.class, () -> calculator.dub());
        calculator.push(100.0);
        calculator.dub();
        assertEquals(calculator.pop(), 100);
        assertEquals(calculator.pop(), 100);
        assertEquals(calculator.pop(), Double.NaN); // and test if stack now empty
    }
}
